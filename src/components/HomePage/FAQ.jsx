...
import PorscheTaycanBack from "../../images/HomePage/faq/porsche-taycan-back.png";
...
function FAQ() {
	...
	return (
		<section className="relative h-full w-full">
			<img src={PorscheTaycanBack} loading="lazy" className="absolute w-[34rem] top-[50%] left-[-10rem] hidden md:flex" alt="car" />
			<div className="flex justify-center mx-10 py-20 md:py-28">
				<div className="max-w-screen-lg z-10">
					<div className="flex flex-col items-center text-center">
						<h2 className="text-2xl font-bold">FAQ</h2>
						<h1 className="text-4xl md:text-5xl font-bold py-4">Frequently Asked Questions</h1>
						...
						<div className="flex flex-col shadow-xl bg-white">
							<div id="qa1" className="border border-neutral-100 cursor-pointer select-none" onClick={() => handleClick("qa1")}>
								<div className={`${openQA === "qa1" ? "bg-green-400 text-white shadow-lg shadow-green-300" : ""} flex justify-between transition duration-100 px-6 sm:px-12 py-5`}>
									<h4 className="md:text-lg font-medium">1. Can I book multiple cars under my name?</h4>
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className={`w-6 h-6 ml-4 self-center transition-transform ${openQA === "qa1" ? "-rotate-180" : ""}`}>
							...
							<div id="qa2" className="border border-t-0 border-neutral-100 cursor-pointer select-none" onClick={() => handleClick("qa2")}>
								<div className={`${openQA === "qa2" ? "bg-green-400 text-white shadow-lg shadow-green-300" : ""} flex justify-between transition duration-100 px-6 sm:px-12 py-5`}>
									<h4 className="md:text-lg font-medium">2. Do you offer non-electric vehicles for rent?</h4>
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className={`w-6 h-6 ml-4 self-center  transition-transform ${openQA === "qa2" ? "-rotate-180" : ""}`}>
										<path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
									</svg>
								</div>
							...
							<div id="qa3" className="border border-t-0 border-neutral-100 cursor-pointer select-none" onClick={() => handleClick("qa3")}>
								<div className={`${openQA === "qa3" ? "bg-green-400 text-white shadow-lg shadow-green-300" : ""} flex justify-between transition duration-100 px-6 sm:px-12 py-5`}>
									<h4 className="md:text-lg font-medium">3. Is there a cancellation fee if I need to change or cancel my reservation?</h4>
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className={`w-6 h-6 ml-4 min-w-[1.1rem] self-center  transition-transform ${openQA === "qa3" ? "-rotate-180" : ""}`}>
										<path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
									</svg>
								</div>
