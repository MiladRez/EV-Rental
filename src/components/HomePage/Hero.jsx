			...
			<div className="relative flex max-w-screen-xl w-full mt-7 items-center justify-center sm:justify-start">
				<div className="w-80 xs:w-[28rem] z-[2] inline-flex justify-center flex-col flex-shrink-0 items-center sm:items-start sm:ml-14 pt-16">
					...
					<div className="flex flex-col xs:flex-row">
						<a href="#book-ride" className="inline-block font-bold bg-green-400 px-6 py-4 border border-green-400 shadow-lg shadow-green-300 hover:shadow-green-400 rounded text-white transition duration-500 hover:text-white hover:bg-green-500 xs:mr-6 my-4" onClick={() => window.scrollTo({top: 800, left: 0, behavior: "smooth"})}>
							Book Ride
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-6 0 24 24" strokeWidth={2} stroke="currentColor" className="inline w-8 h-5">
								<path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
							</svg>
						</a>
						<a href="#learn-more" className="inline-block font-bold bg-neutral-700 px-6 py-4 border border-neutral-700 shadow-lg shadow-neutral-600 hover:shadow-neutral-800 rounded text-white transition duration-500 hover:text-white hover:bg-neutral-900 my-4">
							Learn More
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-6 0 24 24" strokeWidth={2.5} stroke="currentColor" className="inline w-5 h-5">
