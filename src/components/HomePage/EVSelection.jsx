...
import TeslaModelX from "../../images/HomePage/ev-selection/tesla-model-x.png";
import LucidAir from "../../images/HomePage/ev-selection/lucid-air.png";
import FordMustangMachE from "../../images/HomePage/ev-selection/ford-mustang-mach-e.png";
import AudiQ8etron from "../../images/HomePage/ev-selection/audi-q8-etron.png";
import MercedesBenzEQS from "../../images/HomePage/ev-selection/mercedes-benz-eqs.png";
import PorscheTaycan from "../../images/HomePage/ev-selection/porsche-taycan.png";
			...
			<div className="flex justify-center mx-10 md:py-20">
				<div className="w-full max-w-screen-xl">
					<div className="flex flex-col items-center w-full text-center mb-14">
						...
						<p className="text-stone-600 py-4 w-72 md:w-1/3">Choose from a variety of our amazing EVs to rent for your next adventure or business trip</p>
					</div>
