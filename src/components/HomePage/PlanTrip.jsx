...
import SelectCar from "../../images/HomePage/plan-trip/select_car_img.png";
import ContactOperator from "../../images/HomePage/plan-trip/contact_operator_img.png"
import Drive from "../../images/HomePage/plan-trip/drive_img.png";

function PlanTrip() {

	return (
		<section id="learn-more" className='h-full w-full bg-neutral-100'>
			<div className="flex items-center flex-col mx-10 py-20">
				<div className="max-w-screen-xl">
					<div className="flex flex-col items-center mb-14 text-center">
						<h2 className="text-2xl font-bold py-4 text-stone-600">Plan your trip now</h2>
						<h1 className="text-4xl md:text-5xl font-bold py-4">Quick & easy rental process</h1>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center md:py-6 gap-8">
						<div className="flex flex-col items-center md:py-4 md:py-0">
