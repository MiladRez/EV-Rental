...
function Hero() {
	return (
		<section className="relative inline-flex h-screen w-full justify-center bg-neutral-100">
			...
			<div className="relative h-screen inline-flex max-w-screen-xl w-full mt-7 items-center justify-center sm:justify-start">
				<div className="w-80 xs:w-[28rem] z-[2] inline-flex justify-center flex-col flex-shrink-0 items-center sm:items-start sm:ml-16">
					...
					<div>
						<a href="#book-ride" className="inline-block font-bold bg-green-400 px-4 py-2 xs:px-6 xs:py-4 border border-green-400 shadow-lg shadow-green-300 hover:shadow-green-400 rounded text-white transition duration-500 hover:text-white hover:bg-green-500 mr-6">
							Book Ride
						...
						<a href="#learn-more" className="inline-block font-bold bg-neutral-700 px-4 py-2 xs:px-6 xs:py-4 border border-neutral-700 shadow-lg shadow-neutral-600 hover:shadow-neutral-800 rounded text-white transition duration-500 hover:text-white hover:bg-neutral-900">
							Learn More
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="inline ml-2 w-5 h-5">
