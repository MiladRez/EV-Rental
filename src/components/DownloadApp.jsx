...
import GooglePlayStore from "../images/download-app/google-play-store.png";
import AppleAppStore from "../images/download-app/apple-app-store.png";
import Background from "../images/download-app/download-app-bg.jpeg";
import IPhone from "../images/download-app/iphone-display-portrait.png";

function DownloadApp() {
	return (
		<section className="relative h-full w-full bg-neutral-100 overflow-hidden">
			<img src={Background} className="absolute w-full h-full object-cover opacity-30 z-0" alt="page backround abstract" />
				...
				<div className="flex iphone_disappear:justify-around gap-24 w-full max-w-screen-xl z-10">
					<div className="flex flex-col w-[35rem] gap-6 text-center items-center sm:text-start sm:items-start">
						...
						<div className="flex gap-2 lg:gap-8 pt-6 flex-col sm:flex-row">
							<img src={GooglePlayStore} className="w-52 lg:w-56 border-4 border-black rounded-xl bg-black" alt="google play store button"/>
							<img src={AppleAppStore} className="w-52 lg:w-56 border-4 border-black rounded-xl bg-black" alt="apple app store button" />
						</div>
					</div>
